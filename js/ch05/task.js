...
function handleKeyDown(event) {
    ...
    if( changePos === 1 ){
        switch (key) {
			...
			case 38: // 上 xscale+
				dxs += steps;
				document.getElementById("xscl").value = dxs;
				break;
			case 40: // 下 xscale-
				dxs -= steps;
				document.getElementById("xscl").value = dxs;
			...
			case 37: // 左 yscale-
				dys -= steps;
				document.getElementById("yscl").value = dys;
				break;
			case 39: // 右 yscale+
				dys += steps;
				document.getElementById("yscl").value = dys;
			...
			case 96: // 0 zscale-
				dzs -= steps;
				document.getElementById("zscl").value = dzs;
				break;
			case 110: // . zscale+ 
				dzs += steps;
				document.getElementById("zscl").value = dzs;
    ...
    if( changePos === 2 ){
        switch (key) {
			...
			case 38: // 上 xscale+
				cxs += stepcs;
				document.getElementById("xscl").value = cxs;
				break;
			case 40: // 下 xscale-
				cxs -= stepcs;
				document.getElementById("xscl").value = cxs;
			...
			case 37: // 左 yscale-
				cys -= stepcs;
				document.getElementById("yscl").value = cys;
				break;
			case 39: // 右 yscale+
				cys += stepcs;
				document.getElementById("yscl").value = cys;
			...
			case 96: // 0 zscale-
				czs -= stepcs;
				document.getElementById("zscl").value = czs;
				break;
			case 110: // . zscale+ 
				czs += stepcs;
				document.getElementById("zscl").value = czs;
...
function initInterface(){
	...
	document.getElementById("xscl").addEventListener("input", function(event){
	    if(changePos===1)
	        dxs = this.value;
	    else if(changePos===2)
	        cxs = this.value;
	...
	document.getElementById("yscl").addEventListener("input", function(event){
	    if(changePos===1)
	        dys = this.value;
	    else if(changePos===2)
	        cys = this.value;
	...
	document.getElementById("zscl").addEventListener("input",function(event){
	    if (changePos === 1)
	        dzs = this.value;
	    else if (changePos === 2)
	        czs = this.value;
...
function buildModelViewProj(){
	...
	if(changePos == 1){
		...
		//mat4.translate(mvMatrix, mvMatrix, vec3.fromValues(dx, dy, dz));
		mat4.scale(mvMatrix, mvMatrix, vec3.fromValues(dxs, dys, dzs));
	}
	else if(changePos == 2){
		...
		//mat4.translate(mvMatrix, mvMatrix, vec3.fromValues(cx, cy, cz));
		mat4.scale(mvMatrix, mvMatrix, vec3.fromValues(cxs, cys, czs));
	}
...
var interval = setInterval(function(){render();}, 30);
