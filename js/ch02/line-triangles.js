...
function change1(){
	numTimesToSubdivide = document.getElementById("s").value;
	document.getElementById("demo1").innerHTML = "层数: " + numTimesToSubdivide;
}

function change2(){
	numTimesToSubdivide = document.getElementById("s2").value;
	document.getElementById("demo2").innerHTML = "层数: " + numTimesToSubdivide;
}

function change3(){
	numTimesToSubdivide = document.getElementById("s3").value;
	document.getElementById("demo3").innerHTML = "层数: " + numTimesToSubdivide;
}

function frota(){
	x = document.getElementById("dd").value;
	theta = Math.PI/180*x;
	document.getElementById("demo4").innerHTML = "旋转角度: " + x;
}
